...
public class InboundFlights extends Flights {

    private boolean inbound;

    public InboundFlights(boolean isInbound, String departs_at, String arrives_at, String origin_airport, String destination_airport, String airline, String flight_number) {
